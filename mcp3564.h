...
#define MCP3561_RSVD_WRITE      (MCP3561_RSVD_ADDR << _MCP3561_COMMAND_ADDR_POS) | MCP3561_WRITE_COMMAND
#define MCP3561_RSVD_SREAD      (MCP3561_RSVD_ADDR << _MCP3561_COMMAND_ADDR_POS) | MCP3561_SREAD_DATA_COMMAND
#define MCP3561_RSVD_IREAD      (MCP3561_RSVD_ADDR << _MCP3561_COMMAND_ADDR_POS) | MCP3561_IREAD_COMMAND
